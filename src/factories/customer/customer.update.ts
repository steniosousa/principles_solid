...
import { CustomerUpdateController } from "../../useCase/customer/update/customer.update.controller";
import { CustomerUpdateUseCase } from "../../useCase/customer/update/customer.update.useCase";
